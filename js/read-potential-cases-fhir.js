...
(async () => {
  ...
  await fs.writeFile("goodpastures-syndrome-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("goodpastures-syndrome-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
